...
export const CANDIDATE_MAINTENANCE_STARTUP_CATCHUP_HOURS = Number(
  process.env.CANDIDATE_MAINTENANCE_STARTUP_CATCHUP_HOURS || 48
);

export const CANDIDATE_MAINTENANCE_SCOPE = process.env.CANDIDATE_MAINTENANCE_SCOPE || 'followed_plus_top';

export const CANDIDATE_MAINTENANCE_TOP_LIMIT = Number(process.env.CANDIDATE_MAINTENANCE_TOP_LIMIT || 100);

export const CANDIDATE_MAINTENANCE_OBSERVED_LIMIT = Number(
  process.env.CANDIDATE_MAINTENANCE_OBSERVED_LIMIT || 25
);

export const CANDIDATE_MAINTENANCE_REQUEST_BUDGET = Number(
  process.env.CANDIDATE_MAINTENANCE_REQUEST_BUDGET || 250
);
...
export const CANDIDATE_DISCOVERY_ENABLED = parseBoolean(process.env.CANDIDATE_DISCOVERY_ENABLED, false);

export const CANDIDATE_DISCOVERY_INTERVAL_MS = Number(
  process.env.CANDIDATE_DISCOVERY_INTERVAL_MS || 24 * 60 * 60_000
);

export const CANDIDATE_DISCOVERY_GLOBAL_PAGES = Number(process.env.CANDIDATE_DISCOVERY_GLOBAL_PAGES || 10);

export const CANDIDATE_DISCOVERY_MAX_STAGE1_WALLETS = Number(
  process.env.CANDIDATE_DISCOVERY_MAX_STAGE1_WALLETS || 25
);

export const CANDIDATE_DISCOVERY_MAX_DEEP_BACKFILLS = Number(
  process.env.CANDIDATE_DISCOVERY_MAX_DEEP_BACKFILLS || 5
);

export const CANDIDATE_DISCOVERY_REQUEST_BUDGET = Number(process.env.CANDIDATE_DISCOVERY_REQUEST_BUDGET || 75);

export const CANDIDATE_DISCOVERY_OBSERVE_INTERVAL_MS = Number(
  process.env.CANDIDATE_DISCOVERY_OBSERVE_INTERVAL_MS || 48 * 60 * 60_000
);
