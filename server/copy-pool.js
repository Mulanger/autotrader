...
export function ensureTraderProfile(state, wallet, profile = {}) {
  ...
  const next = {
    ...
    allTimeVolumeUsd: existing.allTimeVolumeUsd ?? null,
    allTimeMarketsTraded: existing.allTimeMarketsTraded ?? null,
    allTimeWinRatePct: existing.allTimeWinRatePct ?? null,
    allTimePnlTradeCount: existing.allTimePnlTradeCount ?? null,
    profileStatsSource: existing.profileStatsSource ?? null,
    profileStatsUpdatedAt: existing.profileStatsUpdatedAt ?? null,
